...
import MedicineImage from '@/assets/images/hero/pharmacy.jpg';
import { Eye, EyeOff } from 'lucide-react';

const MedicineStoreLogin = () => {
        ...
        >
            ...
            >
                ...
                <p className="text-center text-sm text-gray-700 mt-2">
                    ...
                    <Link to="/register/medicine-store" className="text-green-600 hover:underline font-medium">
...
export default MedicineStoreLogin;
