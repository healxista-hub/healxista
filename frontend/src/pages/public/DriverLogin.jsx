...
import AmbulanceImage from '@/assets/images/hero/road.jpg'; // Different background for driver
...
const DriverLogin = () => {
    ...
    return (
        <div
            ...
            style={{
                // Fallback to doctor image if ambulance image doesn't exist, or use a neutral one
        ...
        >
            ...
            >
                ...
                <p className="text-center text-sm text-gray-700 mt-2">
                    ...
                    <Link to="/register/driver" className="text-blue-600 hover:underline font-medium">
                        Register as Driver
                    </Link>
                </p>
            </motion.div>
