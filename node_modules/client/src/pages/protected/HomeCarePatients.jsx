    ...
    useEffect(() => {
        const fetchSystemPatients = async () => {
            try {
                ...
                // Fetch only users who have booked this specific doctor
        ...
        <div className="space-y-8 pb-12">
            ...
            >
                <div>
                    ...
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-1">Patient Care Directory</p>
                </div>
