            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Store Name *</label>
                        <Input type="text" placeholder="City Pharmacy" value={storeName} onChange={(e) => setStoreName(e.target.value)} className="h-9" required />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1">
                            ...
                            <Input type="text" placeholder="PHARM123" value={licenseNumber} onChange={(e) => setLicenseNumber(e.target.value)} className="h-9" required />
                        </div>
                        <div className="space-y-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1">
                            ...
                            <Input type="text" placeholder="123 Pharma St" value={address} onChange={(e) => setAddress(e.target.value)} className="h-9" required />
                        </div>
                        <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Operating Hours</label>
                        <Input type="text" placeholder="e.g. 9 AM - 9 PM" value={operatingHours} onChange={(e) => setOperatingHours(e.target.value)} className="h-9" />
                    </div>

                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Email *</label>
                        <Input type="email" placeholder="store@example.com" value={email} onChange={(e) => setEmail(e.target.value)} className="h-9" required />
                    </div>
                ...
                <p className="text-center text-sm text-gray-700 mt-6">
                    ...
                    <Link to="/login/medicine-store" className="text-green-600 hover:underline font-medium">
                        Store Sign In
                    </Link>
                </p>
            </motion.div>
...
export default MedicineStoreRegister;
