...
const HomeCareRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Send agencyName as 'name' for simplicity in backend logic
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        ...
                        <Input type="text" placeholder="John Doe" value={agencyName} onChange={(e) => setAgencyName(e.target.value)} className="h-9" required />
                    </div>

                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Qualification / Role *</label>
                        <Input type="text" placeholder="Registered Nurse, Caretaker, etc." value={ownerName} onChange={(e) => setOwnerName(e.target.value)} className="h-9" required />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                            <label className="text-xs font-semibold text-gray-700 uppercase tracking-wider">Services Offered *</label>
                            <Input type="text" placeholder="Nursing, Elderly Care" value={servicesOffered} onChange={(e) => setServicesOffered(e.target.value)} className="h-9" required />
                        </div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <Input type="number" placeholder="5" value={experienceYears} onChange={(e) => setExperienceYears(e.target.value)} className="h-9" required min="0" />
                    </div>
                ...
                <p className="text-center text-sm text-gray-700 mt-6">
                    ...
                    <Link to="/login/home-care" className="text-indigo-600 hover:underline font-medium">
                        Home Care Sign In
                    </Link>
                </p>
            </motion.div>
...
export default HomeCareRegister;
